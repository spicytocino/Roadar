...
$.fn.PlacePicker = function (t) {
    ...
    $(this).closest("div").hover(function(){
        ...
        var btn = $('<div class="placePickerUIButton" title="Pick location from map" style="width:20px; height:20px;position:absolute;top: '+top+'px;left: '+left+'px;z-index: 1000; "><div><i class="fa fa-map"></i></div></div>');
