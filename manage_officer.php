...
if(!empty($_POST["go"])) {
	...
	$queryCondition = " where firstname like '%" . $_POST['name'] . "%' or lastname like '%" . $_POST['name'] . "%'";
}
$orderby = " ORDER BY a.c_no desc"; 
$sql = "SELECT * ,a.c_no as officer_id from tbl_officer as a left join tbl_stations as b on a.station_id = b.c_no" . $queryCondition;
$href = 'manage_officer.php';					
 ...
 <div class="modal fade" id="editform" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <header class="header position-fixed">
            <div class="row">
                ...
                <div class="mylogo">
					...
					<h1 class="titleheader"> Manage Officer </h1>
                </div>
   ...
   Add New Officer
		...
		<form name="frmlogs" method="post" action="manage_officer.php" >
            <div class="table-title">
                <div class="row">
					...
					<input type="reset" name="go" class="btn btn-default btn-sm w-20 shadow-sm" value="Reset" onclick="window.location='manage_officer.php'" ></p>
                </div>
            </div>
            <table class="table table-striped table-hover table-bordered">
                <thead>
                    <tr>
                        <th>Officer ID</th>
                        <th>Officer Name <i class="fa fa-sort"></i></th>
                        <th>Role</th>
                        <th>Actions</th>
                    </tr>
                </thead>
				...
				<?php
                    ...
                    <tr>
                        ...
                        <td><?php echo $row['salutation'] . " " . $row['firstname'] . " " . $row['middlename'] . " " . $row['lastname']; ?></td>
                        <td><?php echo $row['role']; ?></td>
                        
                        <td>
                            
                            <a href="#" class="edit" title="Edit" data-toggle="modal" data-target="#editform"  data-id="<?php echo  $row['officer_id'] ?>"><i class="material-icons">&#xE254;</i></a>
                            <a href="#" class="delete" title="Delete" id="<?php echo  $row['officer_id'] ?>"><i class="material-icons">&#xE872;</i></a>
                        </td>
                    </tr>
						<?php }} ?>      
                </tbody>
